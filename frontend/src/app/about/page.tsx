      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 text-center">
            منصة <span className="font-bold text-orange-500">LeaseMate</span> هي
            منصة إلكترونية مبتكرة تهدف إلى تسهيل وتطوير عمليات الإيجار العقاري
            في مصر، من خلال حلول رقمية ذكية وآمنة تربط بين المالك والمستأجر بكل
            سهولة وشفافية.
          </p>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            أن نصبح الخيار الأول لإدارة عمليات الإيجار العقاري في العالم العربي،
            عبر تقديم تجربة رقمية متكاملة وآمنة للجميع.
          </p>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 mt-8">
            رسالتنا
          </h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            تمكين المالكين والمستأجرين من إدارة العقود والمدفوعات والتواصل بكل
            سهولة واحترافية، مع ضمان الأمان والشفافية في كل خطوة.
          </p>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 mt-8">
            فريق العمل
          </h2>
