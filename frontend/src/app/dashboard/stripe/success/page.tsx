...
export default function SuccessPage() {
  ...
  const handleManualRedirect = () => {
    if (user?.isSubscribed) {
      ...
      setButtonWarning('يرجى الانتظار حتى يتم تفعيل الاشتراك قبل إضافة وحدة جديدة.');
    }
  };
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 backdrop-blur-sm">
          ...
          {status === 'error' && (
            <>
              ...
              <h1 className="text-xl font-bold text-red-600 dark:text-red-400 mb-4">حدث تأخير في تفعيل الاشتراك</h1>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                تم الدفع بنجاح، ولكن لم يتم تفعيل الاشتراك بعد. من فضلك انتظر دقيقة إضافية ثم حاول مجددًا.
              </p>
              <button
          ...
          {status === 'redirecting' && (
            <>
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">جاري التحويل...</h1>
